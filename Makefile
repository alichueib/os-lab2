...
%.out.expected: %.in bin/mem_shell_sim
	...
	cat $< | bin/mem_shell_sim ${MEM_POOL_SIZE} ${ALLOCATION_POLICY} ${MEM_ALIGNMENT} 2>&1 | grep -E '^ALLOC|^FREE' >$@
